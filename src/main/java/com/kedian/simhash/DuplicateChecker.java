...
public class DuplicateChecker {
    ...
    private final static String STORE_PATH = "F:\\simhash";
    ...
    public DuplicateChecker() throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long gtTime = 1565543007000L;
        long lteTime = gtTime + MINUTE;
        while (lteTime <= ESDBUtil.monthTimeInMillis(0) + EIGHT) {
            long time = System.currentTimeMillis();
            RangeQueryBuilder rangeQueryBuilder = QueryBuilders.rangeQuery("insert_time").gt(gtTime).lte(lteTime);
            SearchRequestBuilder searchRequestBuilder = ESDBUtil.client.prepareSearch("articles201908")
            ...
            for (SearchHit hit : hitsList) {
                ...
                try {
                    ...
                    if (duplicateChecker != null) {
                        ArrayList<String> strings = duplicateChecker.doFilte(simhash);
                        ...
                        if (strings.size() != 0) {
                            ...
                            ESDBUtil.updateSimhash(articlesId, simhash, similarity,"articles201908");
                        } else {
                            ESDBUtil.updateSimhash(articlesId, simhash, "","articles201908");
                            duplicateChecker.addDocument(content, articlesId);
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
