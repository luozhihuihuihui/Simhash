 ...
 */
public class Artiles_eight {
    private static final long MINUTE = 900000L;
    private static final long EIGHT = 28800000L;
    private static final long DAY = 86400000L;

    public static void main(String[] args) {
        Artiles_eight artilesEight = new Artiles_eight();
        artilesEight.start();
    }

    public void start() {
        String index = "articles201908";
        long startTime = ESDBUtil.monthTimeInMillis(-1)+EIGHT;
    ...
    class Task implements Callable {
        ...
        public Object call() throws Exception {
            ...
            ElasticSimhash elasticSimhash = new ElasticSimhash(index, startTime, endTime, MINUTE);
